...
/**
 * Handles the <code>--start</code> command line switch
...
public class StartCommand extends Command
{
  ...
  * command
  */
 public StartCommand(StorageBootstrap manager)
 {
  super(manager);
 }
 ...
 {
  ((StorageBootstrap)getApplicationBean()).setServerStartRequested(true);
 }
 ...
 {
  return "Starts the database server on the local machine if it is not running.";
 }
}
