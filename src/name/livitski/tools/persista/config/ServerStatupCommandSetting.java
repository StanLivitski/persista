...
/**
 * <code>db.server.startup_command</code> setting
 */
public class ServerStatupCommandSetting extends StringSetting<ServerStatupCommandSetting>
{
 public static final String NAME = "db.server.startup_command";

 public ServerStatupCommandSetting()
 {
  super(NAME);
 }
}
