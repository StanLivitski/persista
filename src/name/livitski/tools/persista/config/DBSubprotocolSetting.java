...
/**
 * <code>db.subprotocol</code> setting
 */
public class DBSubprotocolSetting extends StringSetting<DBSubprotocolSetting>
{
 public static final String NAME = "db.subprotocol";

 public DBSubprotocolSetting()
 {
  super(NAME);
  setConstraintPattern("\\w*");
 }
}
