...
/**
 * <code>db.driver_class</code> setting
 */
public class DBDriverClassSetting extends ClassSetting<DBDriverClassSetting>
{
 public static final String NAME = "db.driver_class";

 public DBDriverClassSetting()
 {
  super(NAME);
 }
}
