...
/**
 * <code>db.server.reader.user</code> setting
 */
public class ReaderUserNameSetting extends StringSetting<ReaderUserNameSetting>
{
 public static final String NAME = "db.server.reader.user";

 public ReaderUserNameSetting()
 {
  super(NAME);
