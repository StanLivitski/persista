...
/**
 * <code>db.server.updater.user</code> setting
 */
public class UpdaterUserNameSetting extends StringSetting<UpdaterUserNameSetting>
{
 public static final String NAME = "db.server.updater.user";

 public UpdaterUserNameSetting()
 {
  super(NAME);
  setRequired(true);
