...
import name.livitski.tools.proper2.IntegerSetting;

/**
 * <code>db.server.port</code> setting
 */
public class ServerPortSetting extends IntegerSetting<ServerPortSetting>
{
 public static final String NAME = "db.server.port";

 public ServerPortSetting()
 {
  super(NAME);
 }
}
