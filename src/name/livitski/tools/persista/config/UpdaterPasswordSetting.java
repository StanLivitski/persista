...
import name.livitski.tools.proper2.PasswordSetting;

/**
 * <code>db.server.updater.password</code> setting
 */
public class UpdaterPasswordSetting extends PasswordSetting<UpdaterPasswordSetting>
{
 public static final String NAME = "db.server.updater.password";

 public UpdaterPasswordSetting()
 {
  super(NAME);
  setRequired(true);
  setConstraintPattern(SQL_LITERAL_PATTERN);
 }
}
