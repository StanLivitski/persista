...
import name.livitski.tools.proper2.ClassSetting;

/**
 * <code>hibernate.sql.dialect</code> setting
 */
public class HibernateSQLDialectSetting extends ClassSetting<HibernateSQLDialectSetting>
{
 public static final String NAME = "hibernate.sql.dialect";

 public HibernateSQLDialectSetting()
 {
  super(NAME);
 }
}
