...
/**
 * <code>db.server.reader.password</code> setting
 */
public class ReaderPasswordSetting extends PasswordSetting<ReaderPasswordSetting>
{
 public static final String NAME = "db.server.reader.password";

 public ReaderPasswordSetting()
 {
  super(NAME);
