...
import name.livitski.tools.proper2.StringSetting;

/**
 * <code>jpa.unit.name</code> setting - selects the default
 * persistence unit for bootstrapping JPA.
 */
public class PersistenceUnitNameSetting extends StringSetting<PersistenceUnitNameSetting>
{
 public static final String NAME = "jpa.unit.name";

 public PersistenceUnitNameSetting()
 {
  super(NAME);
  setRequired(true);
  setConstraintPattern("[\\w^\\d][\\w\\.]*");
 }
}
