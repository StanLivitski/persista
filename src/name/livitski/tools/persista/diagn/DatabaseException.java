...
/**
 * Indicates a problem with the database access.
 */
@SuppressWarnings("serial")
public class DatabaseException extends AbstractStorageException
{
 @Override
 ...
 public DatabaseException(ApplicationBean source, String message)
 {
  super(source, message);
 }

 public DatabaseException(ApplicationBean source, SQLException cause)
 {
  super(source, cause);
 }

 public DatabaseException(ApplicationBean source, String message, SQLException cause)
 {
