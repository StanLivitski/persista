...
public class StorageConfigurationException extends AbstractStorageException
{
 @Override
 ...
 public StorageConfigurationException(ApplicationBean source, String message)
 {
  super(source, message);
 }

 public StorageConfigurationException(ApplicationBean source, Exception cause)
 {
  super(source, cause);
 }

 public StorageConfigurationException(ApplicationBean source, String message, Exception cause)
 {
