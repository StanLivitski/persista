...
public abstract class AbstractStorageException extends ApplicationBeanException
{
 public abstract Status asStatus();

 public AbstractStorageException(ApplicationBean source, String message)
 {
  super(source, message);
 }

 public AbstractStorageException(ApplicationBean source, Throwable cause)
 {
  super(source, cause);
 }

 public AbstractStorageException(ApplicationBean source, String message, Throwable cause)
 {
