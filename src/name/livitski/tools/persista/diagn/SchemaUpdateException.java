...
/**
 * Indicates a problem with the database schema update.
 */
@SuppressWarnings("serial")
public class SchemaUpdateException extends AbstractStorageException
{
 @Override
 public Status asStatus()
 {
  return Status.SCHEMA_UPDATE;
 }

 public SchemaUpdateException(ApplicationBean source, String message)
 {
  super(source, message);
 }

 public SchemaUpdateException(ApplicationBean source, Throwable cause)
 {
  super(source, cause);
 }

 public SchemaUpdateException(ApplicationBean source, String message, Throwable cause)
 {
